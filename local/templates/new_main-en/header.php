    ...
    <header class="header">
        <div class="header__nav">
            ...
            <nav class="header__links">
                ...
                <a href="<?=SITE_DIR;?>" class="link">Home</a>
                <a href="<?=SITE_DIR;?>game-schedule/" class="link">Schedule</a>
                <a href="<?=SITE_DIR;?>teams/" class="link">Rating</a>
                <a href="<?=SITE_DIR;?>subscription-plans/" class="link">Subscribe</a>
                <div class="lang-selector js-lang">
                    ...
                    <div class="lang-selector__menu">
                        <div class="lang-selector__menu-item lang-selector__menu-item--active" style="display: inline-flex;">
                            РУС
                            <svg width="13" height="13">
                                <use xlink:href="<?=SITE_TEMPLATE_PATH;?>/img/icons.svg#flag-rus"/>
                            </svg>
                        </div>
                        <a class="lang-selector__menu-item" href="/en/" style="display: inline-flex;">
                            ENG
                            <svg width="13" height="13">
                                <use xlink:href="<?=SITE_TEMPLATE_PATH;?>/img/icons.svg#flag-eng"/>
                            </svg>
                ...
                <? if (!$USER->IsAuthorized()): ?>
                    <a href="<?=SITE_DIR;?>personal/auth/reg.php" class="button button--small">Register</a>
                    <a href="<?=SITE_DIR;?>personal/auth/" class="link">Login</a>
                <? else: ?>
                    <a href="<?=SITE_DIR?>personal/" class="link">Profile</a>
                <? endif; ?>
