...
//dump($arItem);
  ...
  <tr id="<?=$this->GetEditAreaId($arItem['ID']);?>">
    <td style="max-width:200px">
        ...
        ?>
        <?=$placeName;?>
        <?php echo $arItem["DISPLAY_PROPERTIES"]['TYPE_MATCH']["~VALUE"]; ?>
    </td>
    <td style="max-width:200px"><a style="color:white; word-wrap: break-word" href="<?php echo $arItem["DETAIL_PAGE_URL"];?>">
            <?php
            $name = '-';

           if ($arItem["DISPLAY_PROPERTIES"]['TYPE_MATCH']["VALUE_ENUM_ID"]+0 == 5) {
