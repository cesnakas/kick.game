	...
	<?foreach($arCategory["ITEMS"] as $i => $arItem):?>
		...
		<?else:?>
			...
			<div class="bx_item_block others_result">
				<div class="bx_img_element"></div>
				<div class="bx_item_element d-flex align-items-center">
					<!--<a href="<?echo $arItem["URL"]?>">--><?echo $arItem["NAME"];?>
          <form action="" method="post" style="margin-left: auto">
            <input type="hidden" name="team_id" value="<?php echo $arItem['ITEM_ID']?>">
            <button class="btn btn-success btn-sm" type="submit" name="join_submit">Send Request</button>
          </form><!--</a>-->
