        ...
        <form action="" method="get">
          <div class="form-field-wrap">
            <div class="form-field__row">
              ...
              <div class="form-field form-field__checkbox form-field__checkbox_filter">
                <input type="checkbox" class="form-field__checkbox " name="arrFilterDateTime_pf[TYPE_MATCH]" value="6" <?php if($_GET['arrFilterDateTime_pf']['TYPE_MATCH'] == 6) echo 'checked' ?> id="practical">
                <label for="practical" class="form-field__label form-field__label_filter form-field__label-checkbox"><?=GetMessage('FILTER_INPUT_PRACTICAL')?></label>
              </div>
              <div class="form-field form-field__checkbox form-field__checkbox_filter">
                <input type="checkbox" class="form-field__checkbox " name="arrFilterDateTime_pf[TYPE_MATCH]" value="5" <?php if($_GET['arrFilterDateTime_pf']['TYPE_MATCH'] == 5) echo 'checked' ?> id="tournament">
                <label for="tournament" class="form-field__label form-field__label_filter form-field__label-checkbox"><?=GetMessage('FILTER_INPUT_TOURNAMENT')?></label>
              </div>
              <!--<div class="form-field form-field__checkbox form-field__checkbox_filter">
