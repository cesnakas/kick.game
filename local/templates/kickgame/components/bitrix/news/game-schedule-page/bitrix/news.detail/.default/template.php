                    ...
                    <div class="game__block">
                        <div class="game__block-img"
                            ...
                            <div class="game__block-img-rating-bg">
                                <div class="game__block-img-rating">
                                    3.00
                                </div>
                            </div>
                        </div>
                        ...
                        if ($tmp = getParticipationByMatchId($arResult["ID"])) {
                            ...
                            if (isset($tmp[$teamID])) {
                                ...
                                ?>
                                <div class="game__participation-label"><?=GetMessage('GSP_BTN_UPDATE_TEAM_LABEL')?> <?= $tmp[$teamID]; ?></div>
                            <? }
                        ...
                        <?php } ?>
                        <?php if ($isCaptain) { ?>
                            <a href="<?=SITE_DIR?>management-games/join-game/?mid=<?php echo $arResult["ID"]; ?>"
                               class="btn"><?php echo $btnValue; ?></a>
                            <?php if ($arResult["DISPLAY_PROPERTIES"]['TYPE_MATCH']["VALUE_ENUM_ID"] == 5) { ?>
                                <div class="game__block-call">
                                    <a href="https://t.me/joinchat/mRicMNoqO4pkOTgy" target="_blank" class="btn-italic">
                                        <?=GetMessage('GSP_CONTACT_MODERATOR')?>
                                    </a>
                                </div>
                            <?php } ?>
                        <?php } ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-xl-4">
                            <div class="info-item">
                                ...
                                <div>
                                    <? if (!empty($arResult["PROPERTIES"]["URL_STREAM"]['VALUE'])) { ?>
                                        <a href="<?= $arResult["PROPERTIES"]["URL_STREAM"]['VALUE']; ?>"
                                           target="_blank" class="btn-blue"><?=GEtMessage('GSP_ONAIR')?></a>
                                    <? } else { ?>
                                        -
                                    <? } ?>
                                </div>
                ...
                <div class="flex-table">
                 ...
                 <div class="flex-table__param">Rank</div>
                  ...
                  <div class="match-participants__team">
                    <div class="match-participants__team-logo"
                         style="background-image: url(<?php echo CFile::GetPath($teamRank['team']["LOGO_TEAM"]['VALUE']); ?>">
                    </div>
                    <a href="<?=SITE_DIR?>teams/<?= $teamRank['team']['ID']; ?>/"
                       class="match-participants__team-link"><?php echo $teamRank['team']['NAME']; ?> [<?php echo $teamRank['team']["TAG_TEAM"]['VALUE']; ?>]</a>
                  </div>
                </span>
                                <span class="flex-table__param-wrap">
