      ...
      <div class="rating">
        <form action="<?=SITE_DIR?>teams/" method="get">
          <div class="form-field">
			...
			?>
              <input type="text" class="form-field__input" name="teamname" value="<?php echo $teamname;?>" autocomplete="off" id="search-team" placeholder="<?=GetMessage('TEAMS_FORM_PLACEHOLDER')?>">
...
<div class="container">
  <div class="row justify-content-center">
    <div class="col-lg-10 col-md-12">
      <div class="layout__content-anons text-center">
		<a class="btn btn_auth "><?=GetMessage('TEAMS_BTN_TEAMS_LIST')?></a>
