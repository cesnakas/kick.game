...
$MESS['AUTH_FORM_REMEMBER_ME'] = 'Запомнить меня';
$MESS['AUTH_FORGOT_PASSWORD'] = 'Забыли пароль?';
$MESS['AUTH_FORM_FIELD_SUBMIT'] = 'Войти';
$MESS['AUTH_FORM_LOGIN'] = 'Вход';
$MESS['AUTH_FORM_ACCOUNT'] = 'У вас нет аккаунта?';
$MESS['AUTH_FORM_ACCOUNT_CREATE'] = 'Создать аккаунт';
