        ...
        <div class="form-field-wrap">
          <div class="form-field__row">
            ...
            <div class="form-field form-field__checkbox form-field__checkbox_filter">
              ...
              <label for="practical" class="form-field__label form-field__label_filter form-field__label-checkbox">Праки</label>
            </div>
            <div class="form-field form-field__checkbox form-field__checkbox_filter">
              ...
              <label for="tournament" class="form-field__label form-field__label_filter form-field__label-checkbox">Турниры</label>
            </div>
            <!--<div class="form-field form-field__checkbox form-field__checkbox_filter">
