                ...
                <label for="all" class="form-field__label form-field__label_filter form-field__label-checkbox">Все</label>
                                ...
                                <div class="form-field form-field__checkbox form-field__checkbox_filter">
                                    <input type="checkbox" class="form-field__checkbox "
                                           ...
                                           id="practical">
                                    <label for="practical"
                                           class="form-field__label form-field__label_filter form-field__label-checkbox"><?=GetMessage('MG_FILTERS_LABEL_PRAKI')?></label>
                                </div>
                                <div class="form-field form-field__checkbox form-field__checkbox_filter">
                                    <input type="checkbox" class="form-field__checkbox "
                                           name="arrFilterDateTime_pf[TYPE_MATCH]"
                                    ...
                                    <label for="tournament"
                                           class="form-field__label form-field__label_filter form-field__label-checkbox"><?=GetMessage('MG_FILTERS_LABEL_TOURNAMENTS')?></label>
                                </div>
                                <!--<div class="form-field form-field__checkbox form-field__checkbox_filter">
                        ...
                        <div class="form-field  text-center">
                            ...
                            <button class="btn mr-1" type="submit" name="set_filter">
                                <?=GetMessage('MG_FILTERS_BTN_FILTER')?>
                            </button>
                            <button class="btn" type="submit" name="arrFilterDateTime_pf[TYPE_MATCH]" value="">
                                <?=GetMessage('MG_FILTERS_BTN_RESET')?>
                            </button>
                        </div>
                    </form>
